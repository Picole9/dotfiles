...
noremap <F4> :Telescope live_grep hidden=true<CR>
" python run
autocmd FileType python map <buffer> <F9> :w<CR>:exec '!python3' shellescape(@%, 1)<CR>
autocmd FileType python imap <buffer> <F9> <esc>:w<CR>:exec '!python3' shellescape(@%, 1)<CR>
autocmd FileType markdown map <F9> :w<CR>:P glow %<CR>

command! -nargs=* T belowright split | resize 15 | term <args>
command! -nargs=* P belowright vsplit | term <args>
...
set wildmenu " command completion <Tab>
set mouse=a
